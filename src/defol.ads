...
package Defol with Elaborate_Body is
   ...
   protected Pending_Items is
      ...
      --  Clears the "generation in progress" flag and fires Report_Matches if
      --  all dispatched pairs for this size are already Done.
   ...
   private
      ...
      --  Tracks the size group currently being generated by Pair_Generator, so
      --  Done can defer Report_Matches until End_Size_Group is called.
   ...
   --  Name of the report file generated by defol
